...
| Enviar para contato **sem vínculo** acumula risco de LGPD **e** de captação          | Convergente com a regra do §6.2: `relacionamento = DESCONHECIDO` é inelegível para campanha. Um único controle atende às duas normas                                                                                                                    |
